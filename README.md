...
| `POST` | `/api/external-collections/:id/items/:itemId/move`         | Moves a request or folder into another folder or the collection root, carrying its inherited auth and the scripts of the folders it leaves. |
