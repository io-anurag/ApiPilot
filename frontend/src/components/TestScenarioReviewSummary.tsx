  ...
  return (
    <dl data-testid="review-summary" className="flex flex-wrap gap-x-6 gap-y-2 rounded-md border border-border bg-slate-50 dark:bg-white/5 px-4 py-3 text-sm">
      ...
      <div className="flex items-baseline gap-1">
        ...
        <dd data-testid="review-summary-accepted" className="font-semibold text-success-700 dark:text-success-400">
          {summary.accepted}
        </dd>
      </div>
      <div className="flex items-baseline gap-1">
        <dt className="text-muted">Rejected</dt>
        <dd data-testid="review-summary-rejected" className="font-semibold text-danger-700 dark:text-danger-400">
          {summary.rejected}
        </dd>
      </div>
      <div className="flex items-baseline gap-1">
        <dt className="text-muted">Requires review</dt>
        <dd data-testid="review-summary-requires-review" className="font-semibold text-warning-700 dark:text-warning-400">
