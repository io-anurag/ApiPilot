...
/** Canonical per-operation identity: identical method+path+request+assertions are equivalent (FR-012). */
function dedupeKey(scenario: TestScenario): string {
 ...
 * `Provenance.duplicateOfRules` so traceability is preserved (FR-012, SC-004).
 */
