...
official-schema validation, and automated import verification once AP-017 introduces a runner, are
...
- Validate by importing into Newman: rejected because Newman is an AP-017 concern, would make the
