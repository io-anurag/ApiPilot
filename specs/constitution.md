...
**Exception (2026-09-24 amendment)**: A performance-testing feature (AP-029, k6 Performance
Testing) MAY execute a k6 script that ApiPilot generated deterministically (XVI) from a
Performance Plan the user approved, only when all of the following hold:
...
executing any other content elsewhere in the system.
...
local-only and no-secrets conditions preserve the privacy boundary.
...
**Version**: 2.3.0 | **Ratified**: 2026-08-26 | **Last Amended**: 2026-09-24
